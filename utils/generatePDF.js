...
doc.text("Precio Unitario",120,87)
doc.text("Total",165,87)

// TABLE ROW
doc.setTextColor(0,0,0)

const totalPoints = data.points * data.price

doc.text("Instalación punto de red",22,100)
doc.text(String(data.points),95,100)
doc.text(`${data.price} €`,125,100)
doc.text(`${totalPoints} €`,170,100)
...
doc.text("Validez del presupuesto: 15 días",20,180)
doc.text("Garantía: 3 meses sobre trabajos realizados.",20,186)
